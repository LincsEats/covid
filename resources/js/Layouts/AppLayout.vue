            ...
            <nav class="bg-white border-b border-gray-100">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <ul class="menu menu-horizontal">
                                    ...
                                    <li tabindex="0">
                                     ...
                                     <li tabindex="0">
                                        <a><JetNavLink>Vaccine</JetNavLink></a>
                                        <ul class="bg-base-100 p-2">
                                            <li>
                                            <a><JetNavLink :href="route('booking.vaccine')" :active="route().current('booking.vaccine')">Book a Vaccine</JetNavLink></a>
                                            </li>
                                        </ul>
                                    </li>
                                     <li tabindex="0">
                                        <a><JetNavLink>Testing</JetNavLink></a>
                                        <ul class="bg-base-100 p-2">
                                            <li>
                                            <a><JetNavLink :href="route('covidtesting.orderhomekit')" :active="route().current('covidtesting.orderhomekit')">Order A Test</JetNavLink></a>
                                            </li>
                                        </ul>
                                    </li>                                                                        
                                </ul>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden min-h-screen">
                    <div class="pt-16 pb-3 space-y-1 py-10">
                        ...
                        <a><JetNavLink>Vaccine</JetNavLink></a>
                            <ul class="w-fit bg-white">
                            <li><a><JetNavLink :href="route('booking.vaccine')" :active="route().current('booking.vaccine')">Book a Vaccine</JetNavLink></a></li>
                            </ul>
                        </li>
                        <li tabindex="0" class="w-fit">
                        <a><JetNavLink>Testing</JetNavLink></a>
                            <ul class="w-fit bg-white">
                            <li><a><JetNavLink :href="route('covidtesting.orderhomekit')" :active="route().current('covidtesting.orderhomekit')">Order A Test</JetNavLink></a></li>
                            </ul>
                        </li>
                        </ul>
                    </div>
...
<footer class="footer items-center p-4 bg-neutral text-neutral-content">
  ...
  <p class="text-center">COVID-19 Portal Copyright © 2022 - All right reserved</p>
  </div> 
</footer>
</template>
